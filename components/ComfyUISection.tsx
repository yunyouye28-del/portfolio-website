...
export const ComfyUISection: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 font-sans text-gray-900">
        ...
        <div className="mb-48 relative overflow-visible">
            <div className="flex flex-col gap-12 mb-24">
                ...
                <div className="max-w-4xl">
                    ...
                    <p className="text-gray-500 text-lg font-light leading-relaxed max-2xl">
                        除了风景重塑，该工作流在字体材质实验中同样表现优越。通过对字体基础结构的精准捕捉，我们能实现从高透液态玻璃到精密纤维结构的瞬间跨越。
                    </p>
                </div>
            </div>

            {/* Typography Structured Grid */}
        ...
        {/* --- SECTION 7: Template Transformation --- */}
        <div className="h-[1px] w-full bg-black/[0.05] mb-20"></div>
        <div className="mb-48">
        ...
        {/* --- SECTION 8: TikTok 2026 马年 Ident --- */}
        <div className="h-[1px] w-full bg-black/[0.05] mb-20"></div>
        <div className="mb-48">
            <div className="flex flex-col gap-12 mb-20">
                <div className="flex items-center gap-6 opacity-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-16 items-center px-4 md:px-12">
                {[
                  {src: images.tiktokVideo1, poster: images.tmpl29}, 
                  {src: images.tiktokVideo2, poster: images.tmpl31}, 
                  {src: images.tiktokVideo3, poster: images.tmpl33}
                ].map((item, i) => (
